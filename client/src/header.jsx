...
export default function Header() {
  ...
  return (
    ...
    <Link to={'/'}  className='flex'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
...
</svg><span className='font-bold text-xl text-primery'>Rentify</span>
</Link>
